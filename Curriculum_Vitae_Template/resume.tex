...
\section{프로젝트}
  \resumeSubHeadingListStart
    ...
    \resumeProject
      {액션로그 파이프라인}
         ...
         \resumeItemListStart
            ...
            \resumeItem{메달리온 아키텍처 설계 및 클라이언트 조회 패턴 분석 기반 파티셔닝/버켓팅 최적화, 조회 속도 2.5배 증가}
         \resumeItemListEnd
    ...
    \resumeItemListStart
        \resumeItem{Prometheus와 Grafana 기반 모니터링 시스템 구축으로 Observability 확보로 인해 불필요한 Worker EC2 비용 월 45\% 절감}
    ...
    \resumeProject
      ...
      \resumeItemListStart
        ...
        \resumeItem{일일 운영 비용 71.13\% 절감 (\$19.81 → \$5.72)}
      \resumeItemListEnd
