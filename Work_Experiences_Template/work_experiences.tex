  ...
  \resumeProjectListStart
    ...
    \textbf{주요 성과}:
        \begin{itemize}
            ...
            \item Spark Observability 확보: 실시간 이벤트 캡처, 구조화된 메트릭 수집, 자동 분석 프로세스 구축
        \end{itemize}
    ...
    AWS에서 오픈소스로 공개한 Spark History Server MCP를 기반으로, Transient EMR 클러스터 환경에서도 동작하도록 Persistent Spark History Server를 지원하도록 개선했습니다. 
